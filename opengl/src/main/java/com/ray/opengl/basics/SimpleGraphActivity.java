...
import com.ray.opengl.render.Shape;

public class SimpleGraphActivity extends AppCompatActivity {

    public static void launch(Context context, Class<? extends Shape> renderer) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Class<? extends Shape> rendererCls = (Class<? extends Shape>) getIntent().getSerializableExtra("data");
        try {
